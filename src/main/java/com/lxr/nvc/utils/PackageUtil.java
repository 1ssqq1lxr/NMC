...
//          
//        Set set=PackageUtil.getClasses("com.lxr.nvc.annotation");  
//  
//        for (Iterator iter = set.iterator(); iter.hasNext();) {  
//            Class _class=(Class) iter.next();  
//            System.out.println("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< "+_class.getName());  
//            classNames.add(_class.getName());  
//        }  
    	Class<?> loadClass = Thread.currentThread().getContextClassLoader().loadClass("com.lxr.nvc.servlet.ConfigureServlet");
    	Controller annotation = loadClass.getAnnotation(Controller.class);
    	String	url = "123456789".replace( annotation.url(),"");
